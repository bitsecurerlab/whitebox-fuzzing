...
def main():
    ...
    os.system("rm -r " + EXECUTION_PATH + "/bak/* " + EXECUTION_PATH + "/cvc_files/* " + EXECUTION_PATH + "/inputs/* " + EXECUTION_PATH + "/inputs_bak/*")
    ...
    while len(files_list) > 0:
        ...
        if new_input not in processed_input and new_input_first_line not in processed_input:
            ...
            os.system(EXECUTION_PATH+"/run_fuzzing.sh false " + file)
